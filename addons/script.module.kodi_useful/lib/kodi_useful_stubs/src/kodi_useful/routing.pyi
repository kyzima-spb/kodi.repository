...
class QueryParams:
    ...
    def get_bool(self, name: str, default: bool | None = None, required: bool = False) -> bool | None: ...
    @t.overload
    ...
    def get_int_list(self, name: str, default: list[int] | None = None, required: bool = False) -> list[int] | None: ...
